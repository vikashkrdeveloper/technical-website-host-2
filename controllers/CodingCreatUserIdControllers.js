...
const databasefind = require('../model/CodingRegistrationCreateSchema');
const database = require('../model/UserIdCodingRegistrationSchema');
const CodingCreatUserIdControllers = async (req, res) => {
    try {
...
module.exports=CodingCreatUserIdControllers;