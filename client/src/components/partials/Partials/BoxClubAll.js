...
function BoxClubAll(props) {
    ...
    const ruleBook = () => {
        navigate(`/${props.eventname}/event/rule/book`);
    }
    return (
        <>
            <div className=' w-[320px]  m-[20px]  space-y-4 hover:shadow-[1px_1px_20px_1px_rgba(214,216,216,0.2)] shadow-[1px_1px_6px_1px_rgba(214,216,216,0.2)] h-[450px] rounded-[10px]  cursor-default  p-[12px] transition float-left ease-in-out delay-200 border-[1px] border-[#1b3040] bg-[#0a1a23]'>
                ...
                <div className=' w-[100%] h-[80px] flex justify-center  items-center gap-6'>
                    ...
                    <button onClick={ruleBook} className='w-[100px] h-[45px] border-[1px] border-[#253955] rounded-[5px] text-[#ffffffcf] text-[13px] font-[700] bg-[#0a1b2dc4] hover:bg-[#a27332] hover:text-[#fff]  transition ease-in-out delay-150'>RuleBook</button>
                </div>
            </div>
        </>
    )
