        ...
        <>
            <div id='imagebox' className='w-[100%] hidden fixed top-0 left-0 z-50 h-[100vh] bg-[#000000e0] '>
                <div className=' w-[100%] h-[40px] flex justify-end items-center  p-[50px]'>
                    <span class="material-symbols-outlined text-[#fff]  cursor-pointer text-[40px] font-[700]" onClick={fullimageview}>
                        close
                    </span>
                </div>
                <div className='w-[100%] h-[80%] flex justify-center items-center'>
                    <img className='w-[60%] max-[480px]:w-[80%] max-[480px]:h-[50%] h-[100%] rounded-[10px]' src={images[currentIndex]} alt='Loading..' />
                </div>
            </div>
            <div className=' w-[100%] h-[83.3vh] bg-[#0f1627]'>
                <div className='w-[100%] h-[40%]  p-[5px]'>
                    <div className='w-[100%]  h-[160px] mt-4 space-y-4 '>
                        <h1 className=' text-[35px]  text-center font-[600] text-[#ffffffe4] max-[1024px]:text-[25px]'>Check our <span className='text-[#fd0]'>Event Gallery</span></h1>
                        <p className=' text-[14px]  text-center font-[500] text-[#ffffffe0] max-[1024px]:text-[12px]' >Glimpse of our Previous held Events in our College. 🏆✨</p>
                    </div>
                    <div className=' w-[100%] h-[85%] flex justify-center items-center '>
                        <div className=' w-[96%] h-[80%] '>
                            <div className='w-[100%]   h-[auto]'>
                                ...
                                <div className=' min-[1020px]:absolute  min-[1024]:left-[39%] z-40 scale-125 flex  w-[100%]  h-[auto] justify-center items-center'>
                    ...
                    <div className=' w-[100%] h-[200px] mt-4 flex justify-center items-end gap-[100px] pb-[40px]'>
                        <button onClick={handlePrev} className=' border-[1px] text-[#ffffffd1] text-[14px] font-[700] p-[10px] w-[120px] max-[480px]:w-[100px]  max-[480px]:text-[10px] flex justify-center items-center gap-[10px] border-[#244258] rounded-[5px]'>
                            <span class="material-symbols-outlined text-[15px] font-[700]">
                                arrow_back_ios
                            </span>
                            Previous
                        </button>
