...
function HackathonEventRegistration() {
    ...
    const submidformdata = async (event) => {
        ...
        try {
            ...
            const res = await fetch('/participant/hackathon/tech/form', {
                method: 'POST',
                headers: {
            ...
            <div id='box' className='w-[100%]  p-[20px] flex justify-center items-center bg-[#0b1723]'>
                <div className='w-[100%] h-[auto] p-[20px] flex justify-center items-center'>
                    <div className="container">
                        <div className="title">Hackathon Team Registration</div>
                        <hr />
...
export default HackathonEventRegistration
