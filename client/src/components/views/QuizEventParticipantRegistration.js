...
function QuizEventParticipantRegistration() {
    ...
    const submidformdata = async (event) => {
        ...
        try {
            ...
            const res = await fetch('/participant/quiz/tech/form', {
                method: 'POST',
                body: formdata
            })
            if (res.status === 200) {
        ...
        <>
            ...
            <div className='w-[100%] h-[100%] p-[40px] bg-[#0b1321] flex  justify-center items-center'>
                <div className="container ">
                    <div className="title">Quiz Registration</div>
                    <hr />
                        ...
                        <form onSubmit={submidformdata} className='h-[auto]' encType='multipart/form-data' >
                            <div className="user-details">
                                ...
                                <div className="input-box">
                                    ...
                                    <input type="file" id='profileimage' name='profileimage' onChange={handleFileChange} required />
                                </div>
...
export default QuizEventParticipantRegistration
