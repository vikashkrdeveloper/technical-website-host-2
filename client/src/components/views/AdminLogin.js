...
const AdminLogin = () => {
    ...
    const [getdata, setdata] = useState({ adminid: "", password: "" });
    ...
    const datasubmit = async (event) => {
        ...
        if (getdata.adminid >= 0 && getdata.adminid <= 9999999999) {
            try {
                const { adminid, password } = getdata;
            ...
            <div className="w-[100%] h-[91.6vh] bg-[#161f2f] flex justify-center items-center">
                <div className=" w-[350px] bg-[#efefef] h-[400px] rounded-[10px]  border-[2px]">
                    <div className=" w-[100%] h-[50px] flex justify-center items-center  ">
                        <h1 className="text-[22px] font-[700]">Admin Login</h1>
                    </div>
              ...
              <p className=" text-[15px]">Don't have an account?</p><NavLink  to="/participant/signup/" className='text-[14px] font-[700]'>Sign Up</NavLink>
            </div> */}
                    </form>
                </div>
            </div>
